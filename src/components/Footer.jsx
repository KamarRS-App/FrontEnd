  ...
  return (
    <footer className="bg-[#d9f0fd]">
      <Flex justify={['center', 'center', 'space-between']} direction={['column', 'column', 'row']} width="100%" py={{ base: '50px', md: '70px', lg: '80px' }} px={{ base: '20px', md: '50px', lg: '70px' }}>
        ...
        <Box flexBasis={{ base: '100%', md: 'auto' }} pt={{ base: '30px', md: '0', lg: '0' }}>
          <Stack direction={['column', 'column', 'row']} justify={['center', 'center', 'flex-end']} gap="10">
            <Box>
              <UnorderedList listStyleType="none" color="#072051" fontSize="16px">
                <ListItem>
                  <Text fontSize={{ base: '14px', md: '18px', lg: '18px' }} color="#1FA8F6" fontWeight="500">
                    Explore Us
                  </Text>
                </ListItem>
                <ListItem pt="5">

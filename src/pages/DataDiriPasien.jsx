                  ...
                  >
                    ...
                    <GridItem w="100%" h="100%">
                      <FormControl isInvalid={errors.provinsi}>
                        ...
                        <Select {...register('provinsi')} placeholder="-- Pilih provinsi --" onChange={(e) => handlerChangeProvinsiDomisili(e.target.value)}>
                          {provinsi?.map((prov) => {
                            return <option value={prov.id}>{prov.name}</option>;
                          })}
                        </Select>
                  ...
                  >
                    <GridItem w="100%" h="100%">
                      <FormControl isInvalid={errors.noBPJS}>
                        ...
                        <Input {...register('noBPJS')} type="number" isDisabled={!anggotaBpjs} />
                    ...
                    <GridItem w="100%" h="100%">
                      <FormControl isInvalid={errors.kelas_bpjs}>
                        ...
                        <Input {...register('kelas_bpjs')} type="number" isDisabled={!anggotaBpjs} />
                ...
                <Box mt={10}>
                  ...
                  <FormControl mt={5}>
                    ...
                    {previewImageKTP ? (
                      <>
                        <Box>
                          <Button onClick={() => setPreviewImageKtp(null)} bg="#3AB8FF" _hover={{ bg: 'alta.primary' }} color="white">
                            Remove Image
                            <BsFillTrashFill />
                          </Button>
                        </Box>
                    ...
                    <Box h={400} borderWidth="1px" rounded={10} w="100%" mt={5}>
                      <FormControl>
                        <FormLabel htmlFor="img" style={{ cursor: 'pointer' }} h={'100%'}>
                          <Grid justifyContent={'center'} alignItems="center" w="100%" textAlign={'center'}>
                            {previewImageKTP ? (
                              <>
                                <Box w={'100%'} h={'100%'} pt={10}>
                                  <Image src={previewImageKTP} w={'300px'} h={'300px'} />
                                </Box>
                              </>
                            ) : (
                              <>
                  ...
                  <FormControl mt={5}>
                    ...
                    {previewImageBpjs ? (
                      <>
                        <Box>
                          <Button onClick={() => setPreviewImageBpjs(null)} bg="#3AB8FF" _hover={{ bg: 'alta.primary' }} color="white">
                            Remove Image
                            <BsFillTrashFill />
                          </Button>
                        </Box>
                      ...
                      <FormLabel htmlFor="bpjs" style={{ cursor: 'pointer' }}>
                        <Grid justifyContent={'center'} alignItems="center" w="100%" textAlign={'center'}>
                          {previewImageBpjs ? (
                            <>
                              <Box w={'100%'} h={'100%'} pt={10}>
                                <Image src={previewImageBpjs} w={'300px'} h={'300px'} />
                              </Box>
                            </>
                          ) : (
                            <>

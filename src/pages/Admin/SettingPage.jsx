    ...
    <>
      ...
      {!loading && (
        <LayoutAdmin activeMenu={'profile'}>
          <Stack mt={'8'}>
            <Box bg="white" p={{ base: '2', sm: '5', md: '10' }} borderBottom="4px" borderColor="#FAFAFA" textAlign={{ base: 'center', sm: 'left' }}>
              <Text fontSize={'20px'} fontWeight={'600'} color={'#1FA8F6'}>
                Profil
              </Text>
            </Box>
            <Box bg={'white'} px={{ base: '5', sm: '5', md: '10' }} py={{ base: '10', sm: '5', md: '10' }}>
              <form onSubmit={handleUpdateAdmin(onSubmit)}>
                ...
                <Button type="submit" mt={10} bg="#3AB8FF" _hover={{ bg: '#1FA8F6' }} color="white" width={{ base: '36', sm: '56', md: '82', lg: '96' }}>
                  Simpan
                </Button>
              </form>
            </Box>

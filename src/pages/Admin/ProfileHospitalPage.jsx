        ...
        <LayoutAdmin activeMenu={'hospital'}>
            <Stack>
                ...
                <Stack
                    ...
                    py={{ base: '5', sm: '10', md: '16', lg: '20' }}
                >
                    <Box
                        p={'5'}
                        border={'1px'}
                        borderColor={'#E5E5E5'}
                        width={{ base: '250px', sm: '350px', md: '500px', lg: '600px' }}
                        borderRadius={'xl'}
                    >
                        <Image
                            src='/src/assets/images/profil_1.jpg'
                            borderRadius={'xl'}
                        />
                    </Box>
                    <Box
                ...
                modalBody={
                    <>
                        ...
                        <FormControl mt={4}>
                            ...
                            <Input placeholder='Kontak Rumah Sakit' type={'text'} id='kontak' />

...
const UserPage = () => {
  ...
  return (
    <LayoutAdmin activeMenu={'user'}>
      <HeadAdmin title={'Manajemen Admin'} isAdd={onModalCreateOpen} />
      ...
      <PopupDelete isOpen={isOpenModalDelete} onClose={onCloseModalDelete} modalTitle={'Hapus Akun'} modalBody={'Apakah anda yakin untuk menghapus akun?'} deletet_name={'Hapus Akun'} />
    </LayoutAdmin>
  );
};

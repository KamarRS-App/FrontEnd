    ...
    <>
      ...
      {!loading && (
        <Layout>
          ...
          >
            <Text fontWeight={700} fontSize={{ base: '22', sm: '20', md: '24', lg: '30' }} color="#1FA8F6" flexBasis={'full'}>
            ...
            <Box>
              <CardTotalTransfer biaya_registrasi={payment?.biaya_registrasi} kode_daftar={kode_daftar} />
            </Box>
          </Flex>
        </Layout>
      )}

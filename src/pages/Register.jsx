            ...
            <Box className="flex flex-col" mt={10}>
              <Box className="text-start w-full">
                ...
                <FormControl mt={3} isInvalid={errors.no_kk}>
                  <Input {...register('no_kk')} name="no_kk" type={'number'} placeholder="Masukkan No. Kartu Keluarga" />
                  <Text color={'red'}>{errors.no_kk?.message}</Text>
                </FormControl>
                <FormControl mt={3} isInvalid={errors.no_telpon}>
                  <Input {...register('nomorHape')} type="number" placeholder="Masukkan nomor hp" name="nomorHape" />
            ...
            <Box>
              <Center>
                <Text mt="5">
                  ...
                  <Link color="alta.primary" href="#" fontWeight="semibold" onClick={() => navigate('/')}>
                    Login
                  </Link>
                </Text>
              </Center>

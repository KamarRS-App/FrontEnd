...
import { Button, Center, Input, Link, Text, Divider, Flex, Spacer, Image, Box, InputGroup, InputRightElement, FormControl, useToast, FormLabel, Checkbox } from '@chakra-ui/react';
      ...
      <Box>
        ...
        <Flex height={{ base: 'auto', md: 'auto', lg: 'full' }} direction={{ base: 'column', md: 'row', lg: 'row' }}>
          ...
          <Box mx={{ base: 'auto', lg: '0' }} width={{ base: '350px', sm: '500px', md: '700px', lg: '700px' }} px={{ base: '10', lg: '24' }} py={{ base: '16' }}>
            ...
            <Box className="flex flex-col">
              <Box className="text-start w-full">
                <form>
                  ...
                  <Box mt={5}>
                    <Flex direction={'col'} justify={'justify-between'}>
                      <Flex direction={'col'} w={'50%'}>
                        <Checkbox isChecked={isChecked} mr={2} mt={1} id={'isChecked'} onChange={(e) => handleCheckbox(e)}>
                          Remember me
                        </Checkbox>
                      </Flex>
                  ...
                  <Button color="white" width="100%" mt="10" backgroundColor="alta.primary" _hover={{ bg: '#3AB8FF' }} type="submit" onClick={handleSubmit(onSubmit)}>
                    Login
                  </Button>
                </form>
              </Box>
            ...
            <Box mt={10}>
              <Link href="https://rawatinap.online/auth/google/login" target={'_self'}>
            ...
            <Box>
              <Center>
                <Text mt="5">
                  <Link color="#828282" href="#" fontWeight={400} onClick={() => navigate('/admin/login')} mr={10}>
                    Login sebagai Admin
                  </Link>
                  <Link color="alta.primary" href="#" fontWeight="semibold" onClick={() => navigate('/register')}>
                    Sign up
                  </Link>
                </Text>
              </Center>

...
import { Button, Center, Input, Link, Text, Divider, Flex, Spacer, Image, Box, InputGroup, InputRightElement, FormControl, useToast } from '@chakra-ui/react';
              ...
              <Box className="text-start w-full">
                <form>
                  ...
                  <Box className="flex flex-row mt-5 justify-between">
                    <Box>
                      <input type="checkbox" checked={isChecked} className="checkbox checkbox-xs mr-2 border-gray-500" id={'isChecked'} onChange={(e) => handleCheckbox(e)} />

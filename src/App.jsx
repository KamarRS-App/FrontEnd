        ...
        <ChakraProvider theme={theme}>
          <Box minHeight={"100vh"}>
            <Routes>
              ...
              <Route
                path="/rumahsakit/:id/detail"
                element={<DetailCariRumahSakit />}
              />
              <Route
              ...
              />
              <Route
                path="/registrasi/pasien/konfirmasi"
                element={<Pembayaran />}
              />
              <Route path="/registrasi/pembayaran" element={<Payment />} />
              <Route
                path="/registrasi/pembayaran/selesai"
              ...
              />
              <Route
                path="/registrasi/pembayaran/konfirmasi"
                element={<LinkPaymentPage />}
              />
              <Route path="/login/auth/google" element={<AuthGoogle />} />
              <Route
                path="/reservasi/rawat/jalan"
                element={<ReservasiRawatJalan />}
              />
              <Route
                path="/resume/rawat/jalan"
                element={<ResumeRawatJalan />}
              />

...
export default {
    ...
    //Hospital
    createHospital: (token, { kode_rs, nama, foto, alamat, provinsi, kabupaten_kota, kecamatan, no_telepon, email, kelas_rs, pemilik_pengelola, jumlah_tempat_tidur, status_penggunaan, biaya_pendaftaran }) =>
        instance({
            method: `POST`,
            url: `/hospitals`,
            headers: {
    ...
    UpdateHospital: (token, { kode_rs, nama, foto, alamat, provinsi, kabupaten_kota, kecamatan, no_telepon, email, kelas_rs, pemilik_pengelola, jumlah_tempat_tidur, status_penggunaan, biaya_pendaftaran }) =>
        instance({
            method: `PUT`,
            url: `/hospitals`,
            headers: {
